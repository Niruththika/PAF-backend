...
//        System.out.println("Creating comment: " + request); // Debug log
//        return ResponseEntity.ok(commentService.createComment(request));
//    }
//
//    @GetMapping("/post/{postId}")
//    public ResponseEntity<List<CommentResponse>> getCommentsByPostId(@PathVariable Long postId) {
//        System.out.println("Fetching comments for post: " + postId); // Debug log
...
//        System.out.println("Updating comment: " + id); // Debug log
//        return ResponseEntity.ok(commentService.updateComment(id, request));
//    }
//
//    @DeleteMapping("/{id}")
//    public ResponseEntity<Void> deleteComment(@PathVariable Long id) {
//        System.out.println("Deleting comment: " + id); // Debug log
